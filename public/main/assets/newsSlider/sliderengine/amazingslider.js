            ...
            checkMK: function() {
                if (this.options.versionmark != "AMC" + "om" && !(this.options.versionmark == "AML" + "ite" && this.options.skin && $.inArray(this.options.skin, ["classic", "cube", "content"]) >= 0)) {
                    ...
                    if (item.text().indexOf(this.options.watermarktext) <
                        0 || mklink.length < 0) {
                        var itemtext = '<div style="display:block !important;position:absolute;top:6px;left:6px;visibility:visible !important;z-index:999999 !important;font:12px Arial,Tahoma,Helvetica,sans-serif;color:#666;padding:2px 4px;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;background-color:#fff;opacity:0.9;filter:alpha(opacity=90);cursor:pointer;">' + '<a href="' + this.options.watermarklink + '" style="display:none!important;visibility:hidden!important;text-decoration:none;font:1px Arial,Tahoma,Helvetica,sans-serif;color:#333;" title="Responsive jQuery Slider" target="_blank">' +
