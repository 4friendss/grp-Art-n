                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-users"></i> مدیریت کارمندان<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="{{url('admin/usersManagement')}}"> نمایش و مدیریت کارمندان</a>
                                    </li>
                            ...
                            <li><a><i class="fa fa-laptop"></i> مدیریت پروژه ها<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="{{url('admin/projectManagement')}}"> نمایش و مدیریت پروژه ها</a>
                                    </li>
                                    <li><a href="{{url('admin/projectCreate')}}">درج پروژه جدید </a>
                                    </li>
                                </ul>
                            </li>
